...
async function abrirGrupo(id) {
  ...
  f.innerHTML = `
    ...
    <div class="tf-dica" style="margin:4px 0 10px">Escolha a cidade na lista e ela entra no trecho na hora.</div>
  ...
  if (podeEditar) {
    ...
    f.querySelectorAll('#grp-salvar,.cad-del').forEach(el => el.remove());
  }
}
